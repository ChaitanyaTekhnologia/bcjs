...
const CreateScheme = () => {
  ...
  const calculateTotalAmount = () => {
    ...
    const amountPerHead = parseFloat(value.sch_amount_per_head) || 0; 
                ...
                <Col sm={6} className="flex-column d-flex pt-1">
                  <Form.Group>
                    ...
                    >
                      ...
                      {["Scheme Brokerage Amount", "Scheme Brokerage"].map(
                        (option, index) => (
